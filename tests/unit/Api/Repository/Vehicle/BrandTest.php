...
class BrandTest extends TestCase
{
    ...
    public function testShouldFindById()
    {
        ...
        $mockConnection
            ->expects($this->once())
            ->method('executeQuery')
            ->with('SELECT * FROM vehicle_brand WHERE id = ?', [$expectedData['id']])
    ...
    public function testShouldFindByName()
    {
        ...
        $mockConnection
            ->expects($this->once())
            ->method('executeQuery')
            ->with('SELECT * FROM vehicle_brand WHERE name = ?', [$expectedData['name']])
            ->willReturn($mockQuery);
    ...
    public function testShouldSelectAll()
    {
        ...
        $mockConnection
            ->expects($this->once())
            ->method('executeQuery')
            ->with('SELECT * FROM vehicle_brand')
            ->willReturn($mockQuery);
