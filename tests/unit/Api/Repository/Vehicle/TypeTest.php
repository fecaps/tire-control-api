...
class TypeTest extends TestCase
{
    ...
    public function testShouldFindById()
    {
        ...
        $mockConnection
            ->expects($this->once())
            ->method('executeQuery')
            ->with('SELECT * FROM vehicle_type WHERE id = ?', [$expectedData['id']])
    ...
    public function testShouldFindByName()
    {
        ...
        $mockConnection
            ->expects($this->once())
            ->method('executeQuery')
            ->with('SELECT * FROM vehicle_type WHERE name = ?', [$expectedData['name']])
            ->willReturn($mockQuery);
